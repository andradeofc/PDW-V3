...
<html lang="en">
  ...
  <body>
    ...
    <!-- Inicio NavbarLocalização -->
    <NavbarMap> </NavbarMap>
    <!-- Fim NavbarLocalização -->
        ...
        <div class="row mb-5">
          <div class="col-sm-4">
            <div class="card">
              ...
              <img src="../../assets/img/img-card-0.jpg" class="card-img-top">
              <div class="card-body">
          ...
          <div class="col-sm-4">
              <div class="card">
                  ...
                  <img src="../../assets/img/ESTETICISTA.png" class="card-img-top">
                  <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <img src="../../assets/img/makeup.jpg" class="card-img-top">
                    <div class="card-body">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 text-center">
              ...
              <img src="../../assets/img/Celular.png">
              <hr>
            </div>
          </div>
          ...
          <br>
              ...
              e parcerias com seu estabelecimento! </p>    
                <img src="../../assets/img/telapc.png" class="mt-5">
...
import NavbarMap from "@/components/common/NavbarMap";
import Carousel from "@/components/common/Carousel";

export default {
  
  components: {
    Navbar, Carousel, NavbarMap
  },
  data() {
    return {
    };
  ...
  methods: {
    async init(){
      const resp = await this.$services.estabelecimento.getAll()
      console.log(resp)
    },
    login: function() {
